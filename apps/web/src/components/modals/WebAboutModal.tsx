...
interface Props {
	...
	initialView?: "about" | "bugReport" | "viewBugs";
}

export function WebAboutModal({
	onClose,
	supabaseClient,
	user,
	onToast,
	...
	const [bugReportOpen, setBugReportOpen] = useState(initialView === "bugReport");
	const [viewBugsOpen, setViewBugsOpen] = useState(initialView === "viewBugs");
	...
	useEffect(() => {
		if (initialView === "viewBugs") fetchBugReports();
	}, []);
			...
			>
				<div className="about-card">
					...
					<button
						...
						onClick={() => window.open("https://github.com/alexshoe", "_blank")}
					>
						Made by Alex Hsu
						<svg
							viewBox="0 0 16 16"
